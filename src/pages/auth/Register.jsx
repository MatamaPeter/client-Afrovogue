        ...
        >
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-textSecondary">Join our community today</p>
            </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 rounded-lg border border-secondary focus:border-primary focus:ring-2 focus:ring-primary/20 text-textPrimary placeholder-textSecondary transition duration-200 bg-surface"
                  />
                </div>
              </div>
            ...
            <AnimatePresence>
              {message && (
                ...
                >
                  <span>{message}</span>
                  <button onClick={dismissMessage} className="text-textSecondary hover:text-textPrimary">
                    <FiX />
                  </button>
                </motion.div>
              )}
