    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="#" className="text-sm text-slate-600 dark:text-slate-400 hover:text-amber-500 dark:hover:text-amber-400 transition-colors flex items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { name: "Women", bg: "from-rose-100 to-pink-200 dark:from-rose-900/30 dark:to-pink-800/30" },
                { name: "Men", bg: "from-blue-100 to-indigo-200 dark:from-blue-900/30 dark:to-indigo-800/30" },
                { name: "Kids", bg: "from-yellow-100 to-orange-200 dark:from-yellow-900/30 dark:to-orange-800/30" },
                { name: "Couples", bg: "from-purple-100 to-violet-200 dark:from-purple-900/30 dark:to-violet-800/30" }
              ].map((category, index) => (
                <div 
                  key={index}
          ...
          <div className="bg-gradient-to-br from-emerald-100 via-teal-100 to-cyan-200 dark:from-emerald-900/30 dark:via-teal-800/30 dark:to-cyan-700/30 rounded-3xl relative overflow-hidden group cursor-pointer transition-all duration-700 hover:scale-[1.01]">
            ...
            <div className="relative p-8 h-full flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between pt-6 border-t border-slate-300/50 dark:border-slate-600/50">
                <span className="text-sm text-slate-600 dark:text-slate-400 font-mono">VIEW ALL</span>
